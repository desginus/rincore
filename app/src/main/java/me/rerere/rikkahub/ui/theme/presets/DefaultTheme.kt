/* 【域 F·主题渲染】 | 地图: docs/APP_MAP.md §F */
package me.rerere.rikkahub.ui.theme.presets

/* ───【自研】DefaultTheme.kt — 原版无此文件
 * v4.8.7: 预设主题「默认」— 颜色参数与「极简白」几乎相同,
 * 唯一区别: 黄色 (tertiary 系琥珀) 全部替换为莫兰迪紫 (低饱和灰紫)。
 * ───────────────────────────────────────────────────────────────*/
...
/**
 * 默认：纯白/近黑底色，中性灰的表面层级，细淡边框，低饱和蓝作为强调色，
 * 莫兰迪紫（低饱和灰紫）作为点缀色 — 与「极简白」同构，仅点缀色相不同。
 */
val DefaultThemePreset by lazy {
    PresetTheme(
        id = "default",
        name = {
            Text(stringResource(id = R.string.theme_name_default))
        },
...
// v4.8.7: tertiary 系 — 莫兰迪紫 (原极简白为琥珀黄 0xFF8A6A16)
private val tertiaryLight = Color(0xFF8B7D9B)
private val onTertiaryLight = Color(0xFFFFFFFF)
private val tertiaryContainerLight = Color(0xFFF0EBF4)
private val onTertiaryContainerLight = Color(0xFF5D4E6D)
...
// v4.8.7: tertiary 系暗色 — 莫兰迪紫 (原极简白为琥珀黄 0xFFE8CB84)
private val tertiaryDark = Color(0xFFC9B8D6)
private val onTertiaryDark = Color(0xFF3A2E47)
private val tertiaryContainerDark = Color(0xFF52425F)
private val onTertiaryContainerDark = Color(0xFFE8DDF0)
