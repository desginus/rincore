...
/* ───【原版对齐】AppDatabaseFactory.kt | 差异 ±4 行 (基线 2.5.1)
...
internal object AppDatabaseFactory {
    fun create(context: Context, name: String = SQLiteConfiguration.DATABASE_NAME): AppDatabase =
        Room.databaseBuilder(context, AppDatabase::class.java, name)
            ...
            .addMigrations(Migration_6_7, Migration_11_12, Migration_13_14, Migration_14_15, Migration_15_16, MIGRATION_29_30, MIGRATION_30_31)
