...
enum class ToolDomain(
    ...
    // 8. 辅助推理
    // ============================================================
    REASON("辅助推理", "深度推理、方法论分析", listOf("推理", "思考", "分析", "reason", "think", "深度"), null),

    // v4.7.12: REASON_SEQ (辅助推理/序列思考) 随序列思考工具彻底删除 (用户定版:
    // 已有 Task tool, 该工具无实际用途且多次被吸附)
    ...
    // ============================================================
    // 9. 未分类（兜底根域）— v3.6.104: 原「方法域」改名 (用户要求
    //    彻底移除"方法域"字样, 生态位不变: 承接无法归入其他域的工具)
    // ============================================================
    METHOD("未分类", "无法归入其他域的工具", listOf("method", "方法", "流程", "策略", "框架", "分析器", "未分类", "uncategorized"), null),
    ...
    // ============================================================
    // 10.5 插件 (Plugins) — v3.6.88 独立插件系统
    // ============================================================
    PLUGINS("插件", "插件能力模块（技能 + workspace 桥接工具）", listOf("plugin__", "插件", "plugin"), null),
